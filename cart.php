                ...
                <div class="card product_data shadow-sm mb-3">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-2">
                            ...
                            <button class="input-group-text decrement-btn updateQty" style="width: 40px">-</button> 
                            <input type="text" class="form-control text-center input-qty bg-white" value="<?= $citem['prod_qty'] ?>" disabled>
                            <button class="input-group-text increment-btn updateQty" style="width: 40px">+</button>
                            </div>
                        </div>
                        <div class="col-md-2">
